...
function ActionCard({article, action, updateTrigger}) {
    ...
    return (
        ...
        <CardContent>
            <Box gap={2} display={"flex"} flexDirection={"column"}>
                ...
                <Typography gutterBottom variant="h6" component="div" style={{height: "90px", textAlign: "left", fontWeight: "bold", cursor: "pointer"}}  color="text.bold" onClick={() => navigate(`/article/${article.id}`)} >
                {article.title}
                </Typography>
                <Typography variant="h8"  style={{overflow: "hidden", textOverflow: "ellipsis", WebkitLineClamp: 4, WebkitBoxOrient: "vertical", display: "-webkit-box"}}>
                {article.description}
                </Typography>
